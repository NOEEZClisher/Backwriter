...
## Completed: CLI V1 initial Search and View Adapter

The canonical `backwriter` executable implements one-shot human Search and
View. It directly reuses Core Search validation and public Runtime seams.
