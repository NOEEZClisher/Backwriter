...
implemented Backwriter CLI V1 one-shot human and JSON Search/View/Check,
...
Check, Anchor, Edit, Apply, result-binding, Data, and Search/View/Check JSON slice, every other
