...
implemented Backwriter CLI V1 one-shot human and JSON Search/View, human Check,
Session Pick, batch Check, Anchor, Edit, Apply, result-binding, explicit Data,
and JSON Adapter.
Native wire,
...
Check, Anchor, Edit, Apply, result-binding, Data, and Search/View JSON slice, every other
