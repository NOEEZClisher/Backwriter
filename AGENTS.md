...
batch Check, Anchor, Edit, Apply, and result-binding Adapter. Native wire,
...
Check, Anchor, Edit, and Apply slice, every other capability remains deferred Adapter work.
