...
View, Check, and Session Pick modes.
...
collection and an Adapter-parsed predicate directly to Core; one-shot Pick,
Anchor, Edit, Apply, Data, JSON, raw output, and further Session behavior remain
deferred.
